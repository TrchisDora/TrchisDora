...
<body>
    <div class="container">
        ...
        <textarea class="comment" id="cmt" name="NoiDung" placeholder="Để lại bình luận ở đây"></textarea>
        <button name="Gui-cmt">Gửi</button>
            ...
            <div class="comments-section">
                ...
                <div class="comment">
                    ...
                    <p class="comment-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam aliquet enim
                        vel turpis tincidunt posuere.</p>
                </div>
                ...
                <div class="comment">
                    ...
                    <p class="comment-text">Ut rhoncus enim a neque consectetur, at ultricies mauris finibus. Fusce non
                        pellentesque enim.</p>
                </div>
