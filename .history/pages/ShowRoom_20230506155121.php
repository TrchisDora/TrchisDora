...
<body>
    <div class="container">
        ...
        <form action="index.php?url=ShowRoom&id=<?php echo $rsp['MaSP']?>" method="post">
            <div class="Show-cmt">
                <img class="image-transparent"
                    src="https://cdn.tgdd.vn/Files/2022/06/04/1436972/screenshot1340-_1920x1080-800-resize.png"
                    alt="img-background" <p class="cmt-heading">Bình luận của khách hàng</p>
                <?php
